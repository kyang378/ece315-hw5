...
QueueHandle_t Queue_Requests_Joystick, Queue_LCD;
...
void task_hw05_system_control(void *pvParameters){    
    //1. perform discovery to find the other board
    discover_board();

    // 2. after discovery, print out a message indicating that the discovery is complete and which board is the monarch and which board is the subordinate
